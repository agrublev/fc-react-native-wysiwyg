module.exports = {
  ...
  // Map from dashboard var to bool specifying if it can be redefined
  "globals": {
    "__DEV__": true,
    "__dirname": false,
  ...
  "rules": {
    ...
    "no-obj-calls": 1,               // disallow the use of object properties of the dashboard object (Math and JSON) as functions
    ...
    "no-undef": 2,                   // disallow use of undeclared variables unless mentioned in a /*dashboard */ block
